...
Genode::Ram_dataspace_capability Parser::live_data()
{
...
Genode::Ram_dataspace_capability Parser::profile_data()
{
...
*/
Genode::Number_of_bytes Parser::_profile_ds_size()
{
